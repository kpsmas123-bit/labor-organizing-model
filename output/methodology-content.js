...
(function () {
  ...
  var METHODOLOGY_SECTIONS = [
    ...
    /* ═══════════════ SECTORAL LEVERAGE — POPULATED (Draft 2) ═══════════════ */
    {
      ...
      details: [
        ...
        {
          variant: "Full sector rubric — 42 sectors",
          gloss: "Every sector's composite-SVS breakdown, grouped by industry family — read live from the rubric.",
          html: '<p>Every sector carries the four expert-assigned ratings below; the composite SVS is their sum plus the two interaction bonuses (Dual = capital &amp; community reach both &gt; 0; WW = community reach &amp; community-facing both &gt; 0). The same composite is the per-sector weight in both SLS dimensions. All 42 sectors, grouped by industry family, ordered by composite SVS within each group. Values are read live from the sector rubric.</p><p class="svs-fam">Healthcare <span>· 8 sectors</span></p><div class="method-table-wrap"><table class="method-table svs-rubric"><thead><tr><th>Sector</th><th>NAICS</th><th>Cap</th><th>Comm</th><th>Facing</th><th>Non-off</th><th>Bonus</th><th>SVS</th></tr></thead><tbody><tr><td>Hospitals</td><td class="svs-naics">622</td><td>none</td><td>national</td><td>state</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">45</td></tr><tr><td>Federal Hospitals and VA</td><td class="svs-naics">6221, 6222</td><td>none</td><td>state</td><td>state</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">35</td></tr><tr><td>Nursing Homes</td><td class="svs-naics">623</td><td>none</td><td>state</td><td>state</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">35</td></tr><tr><td>State Public Health</td><td class="svs-naics">6222, 6231, 6232</td><td>none</td><td>state</td><td>state</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">35</td></tr><tr><td>Home Health</td><td class="svs-naics">6216</td><td>none</td><td>local</td><td>local</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">25</td></tr><tr><td>Outpatient Care</td><td class="svs-naics">6214</td><td>none</td><td>local</td><td>local</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">25</td></tr><tr><td>Medical Labs</td><td class="svs-naics">6215</td><td>none</td><td>local</td><td>none</td><td>partial</td><td class="svs-bonus">—</td><td class="svs-total">13</td></tr><tr><td>Physician/Dentist Offices</td><td class="svs-naics">6211, 6212</td><td>none</td><td>none</td><td>local</td><td>full</td><td class="svs-bonus">—</td><td class="svs-total">10</td></tr></tbody></table></div><p class="svs-note"><strong>Coding — Healthcare.</strong> All healthcare sectors score Non-Offshorable = non-off (2), because healthcare must be delivered where the patient is. Hospital workers (01) score national community crisis because hospitals are crisis infrastructure in any community; they score zero capital crisis because a hospital strike does not threaten supply chains. Ambulatory and office-based care (03c–03d) score lower community crisis because their disruption is local and diffuse, not systemically crisis-creating. Sectors 12 and 13 are government-employed healthcare workers (QCEW source) scored separately from private hospitals (CBP source).</p><p class="svs-fam">Education <span>· 3 sectors</span></p><div class="method-table-wrap"><table class="method-table svs-rubric"><thead><tr><th>Sector</th><th>NAICS</th><th>Cap</th><th>Comm</th><th>Facing</th><th>Non-off</th><th>Bonus</th><th>SVS</th></tr></thead><tbody><tr><td>K-12 Education</td><td class="svs-naics">6111</td><td>none</td><td>national</td><td>state</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">45</td></tr><tr><td>Public Universities and Community Colleges</td><td class="svs-naics">6112, 6113</td><td>none</td><td>state</td><td>state</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">35</td></tr><tr><td>Private Universities</td><td class="svs-naics">6112, 6113</td><td>none</td><td>local</td><td>state</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">30</td></tr></tbody></table></div><p class="svs-note"><strong>Coding — Education.</strong> K-12 (04) scores national community crisis — no other sector has this level of community saturation. A teachers\' strike closes schools, affects every family with children, and creates immediate political pressure at every level of government. Public universities (05a) score state-level community crisis; private universities (05b) score local because their crisis impact is more contained and their political relationships less institutionally embedded. Employment for 04 uses CBP (private schools) + QCEW (public schools); 05a uses QCEW only (own=2,3); 05b uses CBP only (own=5).</p><p class="svs-fam">Logistics & Transport <span>· 9 sectors</span></p><div class="method-table-wrap"><table class="method-table svs-rubric"><thead><tr><th>Sector</th><th>NAICS</th><th>Cap</th><th>Comm</th><th>Facing</th><th>Non-off</th><th>Bonus</th><th>SVS</th></tr></thead><tbody><tr><td>Air</td><td class="svs-naics">481</td><td>national</td><td>national</td><td>none</td><td>full</td><td class="svs-bonus"><span class="svs-b">Dual</span></td><td class="svs-total">60</td></tr><tr><td>Rail Passenger</td><td class="svs-naics">482</td><td>state</td><td>state</td><td>state</td><td>full</td><td class="svs-bonus"><span class="svs-b">Dual</span> <span class="svs-b">WW</span></td><td class="svs-total">55</td></tr><tr><td>Rail Freight</td><td class="svs-naics">482111, 482112</td><td>national</td><td>state</td><td>none</td><td>full</td><td class="svs-bonus"><span class="svs-b">Dual</span></td><td class="svs-total">50</td></tr><tr><td>Ports</td><td class="svs-naics">4883</td><td>national</td><td>local</td><td>none</td><td>full</td><td class="svs-bonus"><span class="svs-b">Dual</span></td><td class="svs-total">45</td></tr><tr><td>Couriers FedEx</td><td class="svs-naics">4922</td><td>national</td><td>none</td><td>none</td><td>full</td><td class="svs-bonus">—</td><td class="svs-total">30</td></tr><tr><td>Couriers Other</td><td class="svs-naics">4922</td><td>local</td><td>local</td><td>none</td><td>full</td><td class="svs-bonus"><span class="svs-b">Dual</span></td><td class="svs-total">30</td></tr><tr><td>Couriers UPS</td><td class="svs-naics">4922</td><td>national</td><td>none</td><td>none</td><td>full</td><td class="svs-bonus">—</td><td class="svs-total">30</td></tr><tr><td>Trucking General</td><td class="svs-naics">4841</td><td>local</td><td>local</td><td>none</td><td>full</td><td class="svs-bonus"><span class="svs-b">Dual</span></td><td class="svs-total">30</td></tr><tr><td>Warehousing</td><td class="svs-naics">4931</td><td>local</td><td>none</td><td>none</td><td>full</td><td class="svs-bonus">—</td><td class="svs-total">15</td></tr></tbody></table></div><p class="svs-note"><strong>Coding — Logistics & Transport.</strong> All logistics sectors score Non-Offshorable = non-off (2) — logistics work must happen where the infrastructure is. Courier sub-sectors (07b/07c/07d) share NAICS 4922 employment but are tagged by hub geography: Jefferson County KY = UPS (07b), Shelby County TN = FedEx (07c), all other counties = Other (07d). UPS hub counties score national capital crisis because Worldport handles half of UPS global volume; FedEx hub counties score the same but carry the * notation. Non-hub courier counties score local reach on both axes. Rail splits by passenger/freight geography: counties with known Amtrak hubs or commuter rail terminals tag to 09b; all others default to 09a.</p><p class="svs-fam">Social Services <span>· 2 sectors</span></p><div class="method-table-wrap"><table class="method-table svs-rubric"><thead><tr><th>Sector</th><th>NAICS</th><th>Cap</th><th>Comm</th><th>Facing</th><th>Non-off</th><th>Bonus</th><th>SVS</th></tr></thead><tbody><tr><td>Childcare</td><td class="svs-naics">6244</td><td>none</td><td>local</td><td>local</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">25</td></tr><tr><td>Social Services</td><td class="svs-naics">6241, 6242, 6243</td><td>none</td><td>local</td><td>local</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">25</td></tr></tbody></table></div><p class="svs-note"><strong>Coding — Social Services.</strong> Childcare (11b) is carved out from the NAICS 624 aggregate. Employment = NAICS 6244 employment; Social Services (11) employment = 6241+6242+6243 (i.e., 624 total minus 6244). Both sectors score identically on all four variables and both bonuses — the carve-out is for display and organizing specificity, not because the scores differ. Employment source: CBP (private) + QCEW (government-owned social service agencies) for both sectors.</p><p class="svs-fam">Public Sector — Services <span>· 5 sectors</span></p><div class="method-table-wrap"><table class="method-table svs-rubric"><thead><tr><th>Sector</th><th>NAICS</th><th>Cap</th><th>Comm</th><th>Facing</th><th>Non-off</th><th>Bonus</th><th>SVS</th></tr></thead><tbody><tr><td>Public Utilities</td><td class="svs-naics">221</td><td>state</td><td>state</td><td>none</td><td>full</td><td class="svs-bonus"><span class="svs-b">Dual</span></td><td class="svs-total">40</td></tr><tr><td>Public Transit</td><td class="svs-naics">485</td><td>none</td><td>state</td><td>state</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">35</td></tr><tr><td>Public Sanitation</td><td class="svs-naics">562</td><td>none</td><td>state</td><td>local</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">30</td></tr><tr><td>Parks and Recreation</td><td class="svs-naics">7121</td><td>none</td><td>none</td><td>local</td><td>full</td><td class="svs-bonus">—</td><td class="svs-total">10</td></tr><tr><td>Public Libraries</td><td class="svs-naics">5191</td><td>none</td><td>none</td><td>local</td><td>full</td><td class="svs-bonus">—</td><td class="svs-total">10</td></tr></tbody></table></div><p class="svs-note"><strong>Coding — Public Sector — Services.</strong> All sectors in this family are government-employed workers (QCEW source, own=2,3); none use CBP. Transit (14) and sanitation (16) score state-level community crisis because their disruption is immediately felt by daily commuters and households. Utilities (15) scores state-level on both capital and community crisis — a utility outage is simultaneously a capital disruption and a community crisis. Libraries (17) and parks (18) score zero community crisis: their absence, while a loss, does not create a systemic crisis in the way that transit or sanitation absence does.</p><p class="svs-fam">Public Sector — Admin <span>· 3 sectors</span></p><div class="method-table-wrap"><table class="method-table svs-rubric"><thead><tr><th>Sector</th><th>NAICS</th><th>Cap</th><th>Comm</th><th>Facing</th><th>Non-off</th><th>Bonus</th><th>SVS</th></tr></thead><tbody><tr><td>Human Services Administration</td><td class="svs-naics">9231</td><td>none</td><td>local</td><td>local</td><td>full</td><td class="svs-bonus"><span class="svs-b">WW</span></td><td class="svs-total">25</td></tr><tr><td>Government Administration</td><td class="svs-naics">9211</td><td>none</td><td>local</td><td>none</td><td>full</td><td class="svs-bonus">—</td><td class="svs-total">15</td></tr><tr><td>Justice and Police</td><td class="svs-naics">9221</td><td>none</td><td>local</td><td>none</td><td>full</td><td class="svs-bonus">—</td><td class="svs-total">15</td></tr></tbody></table></div><p class="svs-note"><strong>Coding — Public Sector — Admin.</strong> All three sectors are government-employed workers (QCEW source). Community crisis reach is local for all — government administration disruption affects municipal services, not state or national systems. Human Services Administration (21) scores community-facing reach because caseworkers, benefits administrators, and social workers are embedded in client relationships. Government Administration (19) and Justice/Police (20) do not score community-facing because those roles are institutional, not relational in the same sense. Justice/Police (20) carries the ‡ notation — SVS measures worker-community solidarity leverage; police union political influence operates through a different mechanism not captured here.</p><p class="svs-fam">Manufacturing <span>· 3 sectors</span></p><div class="method-table-wrap"><table class="method-table svs-rubric"><thead><tr><th>Sector</th><th>NAICS</th><th>Cap</th><th>Comm</th><th>Facing</th><th>Non-off</th><th>Bonus</th><th>SVS</th></tr></thead><tbody><tr><td>Manufacturing Aerospace</td><td class="svs-naics">3364</td><td>national</td><td>none</td><td>none</td><td>partial</td><td class="svs-bonus">—</td><td class="svs-total">28</td></tr><tr><td>Manufacturing Auto</td><td class="svs-naics">3361</td><td>national</td><td>none</td><td>none</td><td>partial</td><td class="svs-bonus">—</td><td class="svs-total">28</td></tr><tr><td>Manufacturing General</td><td class="svs-naics">31-33</td><td>local</td><td>none</td><td>none</td><td>none</td><td class="svs-bonus">—</td><td class="svs-total">10</td></tr></tbody></table></div><p class="svs-note"><strong>Coding — Manufacturing.</strong> Auto (22) and Aerospace (23b) are carved out from the NAICS 31–33 aggregate: 3361 = 9.5% of total manufacturing employment, 3364 = 3.5%. Both score national capital crisis — auto supply chains are nationally integrated; aerospace is strategically critical infrastructure. Both score partial offshorability because assembly lines are geographically anchored even if components are offshored. Manufacturing General (23) gets the remainder of 31–33 employment. It scores local capital crisis only and fully offshorable — the general manufacturing workforce is the most exposed to relocation and automation pressure in the model. No manufacturing sector scores community crisis or community-facing reach.</p><p class="svs-fam">Goods & Consumer <span>· 4 sectors</span></p><div class="method-table-wrap"><table class="method-table svs-rubric"><thead><tr><th>Sector</th><th>NAICS</th><th>Cap</th><th>Comm</th><th>Facing</th><th>Non-off</th><th>Bonus</th><th>SVS</th></tr></thead><tbody><tr><td>Construction</td><td class="svs-naics">23</td><td>local</td><td>none</td><td>none</td><td>full</td><td class="svs-bonus">—</td><td class="svs-total">15</td></tr><tr><td>Food Service</td><td class="svs-naics">722</td><td>local</td><td>none</td><td>none</td><td>full</td><td class="svs-bonus">—</td><td class="svs-total">15</td></tr><tr><td>Hotels</td><td class="svs-naics">721</td><td>local</td><td>none</td><td>none</td><td>full</td><td class="svs-bonus">—</td><td class="svs-total">15</td></tr><tr><td>Retail</td><td class="svs-naics">44-45</td><td>local</td><td>none</td><td>none</td><td>full</td><td class="svs-bonus">—</td><td class="svs-total">15</td></tr></tbody></table></div><p class="svs-note"><strong>Coding — Goods & Consumer.</strong> All four sectors are local capital disruptors only — a construction strike stops one project, a retail strike affects one chain\'s local stores. None creates community crisis at scale, and none scores community-facing reach in the McAlevey sense. All four score non-offshorable: construction, food service, and retail must happen where the customer is. SVS 15 across the board reflects this profile — present but not strategically high-value for organizing.</p><p class="svs-fam">Energy & Infrastructure <span>· 2 sectors</span></p><div class="method-table-wrap"><table class="method-table svs-rubric"><thead><tr><th>Sector</th><th>NAICS</th><th>Cap</th><th>Comm</th><th>Facing</th><th>Non-off</th><th>Bonus</th><th>SVS</th></tr></thead><tbody><tr><td>Energy Upstream</td><td class="svs-naics">211, 212, 213</td><td>national</td><td>state</td><td>none</td><td>partial</td><td class="svs-bonus"><span class="svs-b">Dual</span></td><td class="svs-total">48</td></tr><tr><td>Telecom</td><td class="svs-naics">517</td><td>national</td><td>none</td><td>none</td><td>full</td><td class="svs-bonus">—</td><td class="svs-total">30</td></tr></tbody></table></div><p class="svs-note"><strong>Coding — Energy & Infrastructure.</strong> Telecom (30) is grouped here rather than with Tech/Finance because its capital crisis reach profile (national) matches the infrastructure chokepoint pattern, not the software/finance pattern. A telecom outage is catastrophic for capital at national scale. Energy Upstream (28) scores the Dual-Crisis Bonus — an oil, gas, or mining shutdown threatens capital accumulation nationally and creates state-level community crisis (fuel prices, heating, supply disruption). It scores partial offshorability because extraction is geographically anchored but operational management is increasingly portable. Telecom scores non-offshorable: physical network infrastructure must be maintained locally even as operations are centralized.</p><p class="svs-fam">Tech & Finance <span>· 2 sectors</span></p><div class="method-table-wrap"><table class="method-table svs-rubric"><thead><tr><th>Sector</th><th>NAICS</th><th>Cap</th><th>Comm</th><th>Facing</th><th>Non-off</th><th>Bonus</th><th>SVS</th></tr></thead><tbody><tr><td>Finance and Banking</td><td class="svs-naics">52</td><td>state</td><td>none</td><td>none</td><td>none</td><td class="svs-bonus">—</td><td class="svs-total">15</td></tr><tr><td>Tech and Information</td><td class="svs-naics">51</td><td>local</td><td>none</td><td>none</td><td>none</td><td class="svs-bonus">—</td><td class="svs-total">10</td></tr></tbody></table></div><p class="svs-note"><strong>Coding — Tech & Finance.</strong> Both sectors score Offshorable (0) — the defining characteristic of this family. Software development, data processing, and financial back-office work are highly portable; the employer relocation threat is credible and has been exercised repeatedly. Tech/Information (29) excludes 5191 (Libraries, counted in sector 17) and 517 (Telecom, counted in sector 30). Finance/Banking (31) scores state-level capital crisis: regional bank failures create state-level financial disruption, but the federal backstop limits national crisis. Neither sector scores community crisis or community-facing reach — these workers are not embedded in the communities they affect.</p><p class="svs-fam">Agriculture <span>· 1 sector</span></p><div class="method-table-wrap"><table class="method-table svs-rubric"><thead><tr><th>Sector</th><th>NAICS</th><th>Cap</th><th>Comm</th><th>Facing</th><th>Non-off</th><th>Bonus</th><th>SVS</th></tr></thead><tbody><tr><td>Agriculture</td><td class="svs-naics">11</td><td>local</td><td>none</td><td>none</td><td>partial</td><td class="svs-bonus">—</td><td class="svs-total">13</td></tr></tbody></table></div><p class="svs-note"><strong>Coding — Agriculture.</strong> Agriculture workers are excluded from NLRA coverage in most jurisdictions, severely limiting the formal organizing tools available. The SVS score reflects the sector\'s structural characteristics (local capital crisis only, partial offshorability, no community-facing reach), but the † notation flags that the score overstates active leverage given legal barriers to organizing. Employment source: CBP (NAICS 11). Seasonal and migrant workers are underrepresented in CBP data.</p>'
        }
      ],
      rationale: [
  ...
  function injectStyles() {
    ...
    var css = ''
      ...
      + '.svs-fam { font-family: var(--font-mono, monospace); font-size: 12px; letter-spacing: 0.08em; text-transform: uppercase; color: var(--color-accent, #BD0026); margin: 20px 0 6px; padding-top: 10px; border-top: 1px solid var(--color-rule, #C8C3B8); }'
      + '.svs-fam:first-of-type { border-top: none; padding-top: 0; margin-top: 8px; }'
      + '.svs-fam span { color: var(--color-text-muted, #888); font-weight: 400; letter-spacing: 0; text-transform: none; }'
      + 'table.svs-rubric { font-size: 12.5px; }'
      + 'table.svs-rubric th, table.svs-rubric td { white-space: nowrap; padding-left: 7px; padding-right: 7px; }'
      + 'table.svs-rubric td:first-child, table.svs-rubric th:first-child { white-space: normal; min-width: 7.5em; padding-left: 0; }'
      + 'table.svs-rubric .svs-naics { font-family: var(--font-mono, monospace); font-size: 11px; color: var(--color-text-muted, #777); }'
      + 'table.svs-rubric .svs-total { font-weight: 700; color: var(--color-accent, #BD0026); text-align: right; }'
      + 'table.svs-rubric .svs-bonus { font-family: var(--font-mono, monospace); font-size: 10.5px; }'
      + '.svs-b { display: inline-block; background: rgba(189,0,38,0.10); color: var(--color-accent, #BD0026); border-radius: 3px; padding: 0 5px; margin-right: 3px; font-weight: 600; }'
      + '.svs-note { font-size: 12px; color: var(--color-text-secondary, #555); line-height: 1.55; margin: 6px 0 4px; }';
